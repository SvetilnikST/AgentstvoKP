    ...
    <div class="row">
        ...
        <div class="form-group"> <label>Улица</label>
            ...
            <div class="form-group"> <label>Дом</label>
                <input type="text" name="locationHouse" class="form-control" placeholder="Введите дом"  value="<c:out value="${locationEntity.locationHouse}"/>"/> </div>

            <div class="form-group"> <label>Корпус</label>
                <input type="text" name="locationCorps" class="form-control" placeholder="Введите корпус"  value="<c:out value="${locationEntity.locationCorps}"/>"/> </div>

            <div class="form-group"> <label>Квартира</label>
                <input type="text" name="locationFlat" class="form-control" placeholder="Введите квартиру"  value="<c:out value="${locationEntity.locationFlat}"/>"/> </div>
