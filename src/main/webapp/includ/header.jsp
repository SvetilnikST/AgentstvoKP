...
<nav class="navbar navbar-expand-md bg-primary navbar-dark">
    <div class="container">
        <a class="navbar-brand" href="#"><i class="fa d-inline fa-lg fa-cloud"></i><b> Учет сделок агентства
            недвижимости</b></a>
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
            ...
            <a href="WorkTaskController?action=logout" class="btn navbar-btn ml-2 text-white btn-secondary"><i
                    class="fa d-inline fa-lg fa-user-circle-o"></i> Выйти</a>
...
" href="WorkTaskController?action=deal" text-white>Сделки</a>
                ...
                <li class="nav-item">
                    <a class="nav-link
                    <c:if test="${markreportdeal eq 1}">
                    active
                    </c:if>
" href="WorkTaskController?action=report_deal">Отчеты</a>
                </li>
