    ...
    <div class="row">
        ...
        <div class="form-group"> <label>Сделки</label>
            ...
            <div class="form-group"> <label>Дата сделки</label>
                <input type="date" name="dateDeal" class="form-control" placeholder="Введите дату"  value="<c:out value="${dealEntity.dateDeal}"/>"/> </div>
            ...
            <div class="form-group"> <label>Поставщик</label>
                ...
                <div class="form-group"> <label>Покупатель</label>
                    ...
                    <input type="text" name="dealSum" class="form-control" placeholder=""  value="<c:out value="${dealEntity.dealSum}"/>"/> </div>

                <div class="form-group"> <label>Процент %</label>
                    <input type="text" name="dealPercent" class="form-control" placeholder=""  value="<c:out value="${dealEntity.dealPercent}"/>"/> </div>
