...
<table class="table table-striped">
    ...
    <c:forEach items="${property}" var="propert">
        <tr>
            ...
            <td><a href="WorkTaskController?action=edit_property&id=<c:out value = "${propert.idProperty}"/>">Редактировать</a>
            </td>
            <td>
                <a href="WorkTaskController?action=delete_property&id=<c:out value = "${propert.idProperty}"/>">Удалить</a>
